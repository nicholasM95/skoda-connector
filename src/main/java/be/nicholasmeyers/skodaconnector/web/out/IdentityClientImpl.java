...
import be.nicholasmeyers.skodaconnector.exception.LoginException;
import be.nicholasmeyers.skodaconnector.resource.*;
import be.nicholasmeyers.skodaconnector.service.IdentityService;
import be.nicholasmeyers.skodaconnector.web.out.resource.OpenidConfigurationWebResponseResource;
import be.nicholasmeyers.skodaconnector.web.out.resource.PostEmailPasswordWebRequestResource;
import be.nicholasmeyers.skodaconnector.web.out.resource.PostEmailWebRequestResource;
import feign.Feign;
...
import static be.nicholasmeyers.skodaconnector.utils.HeaderUtils.getCookieHeader;
import static be.nicholasmeyers.skodaconnector.utils.HeaderUtils.getLocationHeader;
import static be.nicholasmeyers.skodaconnector.utils.StringUtils.getHmacFromString;
import static be.nicholasmeyers.skodaconnector.utils.StringUtils.getCsrfFromString;
import static be.nicholasmeyers.skodaconnector.utils.StringUtils.getResponseBodyAsString;
